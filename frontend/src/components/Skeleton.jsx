// Loading placeholders. A light band sweeps across a block that mirrors the
// shape of the content it stands in for — calmer than a "Loading…" line and it
// keeps layout from jumping when data arrives. The `.skeleton` shimmer is
// defined in index.css and quieted by the global prefers-reduced-motion rule.

export default function Skeleton({ className = "" }) {
  return (
    <div className={`skeleton rounded-md bg-slate-100 ${className}`} />
  );
}
